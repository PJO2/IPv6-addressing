...
IPv6 en utilisant un format d'adresse en 128 bits au lieu de 32 bits pour IPv4 permet d'allouer un nombre d'adresses en apparence illimité ([150 bits permettent de compter les atomes de la terre](https://fr.wikipedia.org/wiki/Ordres_de_grandeur_de_nombres#1039_%C3%A0_10100)). Ce format permet d'attribuer des adresses uniques à chaque nouvel objet pour un très grand nombre d'années. En effet, le nombre d'adresses MAC allouées (c'est à dire le nombre d'interfaces réseaux) montre que les 48 bits disponibles pour Ethernet 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzUwNzgyNzQwLC0yOTQzMTIwNjIsMjAyNz
